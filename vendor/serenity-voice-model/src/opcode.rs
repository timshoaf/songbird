...
pub enum Opcode {
    ...
    ClientDisconnect = 13,
    /// Prepare protocol transition for DAVE/E2EE.
    DavePrepareTransition = 21,
    /// Execute protocol transition for DAVE/E2EE.
    DaveExecuteTransition = 22,
    /// Client indicates readiness for a transition.
    DaveTransitionReady = 23,
    /// Prepare epoch for DAVE/E2EE.
    DavePrepareEpoch = 24,
    /// DAVE MLS external sender package (binary opcode in gateway framing).
    DaveMlsExternalSender = 25,
    /// DAVE MLS key package (binary opcode in gateway framing).
    DaveMlsKeyPackage = 26,
    /// DAVE MLS proposals (binary opcode in gateway framing).
    DaveMlsProposals = 27,
    /// DAVE MLS commit welcome (binary opcode in gateway framing).
    DaveMlsCommitWelcome = 28,
    /// DAVE MLS announce commit transition (binary opcode in gateway framing).
    DaveMlsAnnounceCommitTransition = 29,
    /// DAVE MLS welcome (binary opcode in gateway framing).
    DaveMlsWelcome = 30,
