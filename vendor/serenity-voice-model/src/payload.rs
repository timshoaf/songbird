...
pub struct Identify {
    /// Maximum supported DAVE protocol version.
...
pub struct SessionDescription {
    ...
    /// Negotiated DAVE protocol version when E2EE is in use.
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// Used to announce protocol transition preparation for DAVE.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize)]
...
/// Used to execute protocol transition for DAVE.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize)]
pub struct DaveExecuteTransition {
    pub transition_id: u32,
}

/// Used by client to indicate transition readiness.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize)]
pub struct DaveTransitionReady {
    pub transition_id: u32,
}

/// Used to prepare an MLS epoch for DAVE.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize)]
...
/// Used by client to report invalid commit/welcome processing.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize)]
